...
# Agendamentos por funil (CC1 agendadas do mês)
ag_por_funil = {}
...
# Perdidos por funil + taxa de perda (perdidos / leads do funil)
perdidos_por_funil = {}
...
# Profissão por produto/funil (ranking, normalizado por capitalização)
